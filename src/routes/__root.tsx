  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-heading text-7xl font-bold text-gradient-ember">404</h1>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-lg bg-gradient-ember px-6 py-2.5 text-sm font-bold text-ember-foreground transition-opacity hover:opacity-90"
          >
            Go home
          </Link>
        </div>
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "BiteHub — Cafeteria Ordering" },
      { name: "description", content: "Order food from your cafeteria quickly and easily" },
